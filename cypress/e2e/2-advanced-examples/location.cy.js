...
context('Check the AIN website', () => {
  ...
  it('Open the main page and click startups', () => {
    // cy.viewport(1550, 950)
    cy.visit('https://ain.ua/ru/')
    cy.get('#header > div > div.header-bottom > button').click()
    // cy.click('#fixed-head > div > div > button')
    // cy.click('#subbody > div.main-content > div > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div > div > a:nth-child(1)')
